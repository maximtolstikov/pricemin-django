$(document).ready(function(){
    ...
    $(".rules").click(function () {
        ...
        $("#prompt").slideDown();
	    $("#prompt_p").append("<span class='prompt1 text_x-large'>");
	    $(".prompt1").text("Правила использования сервиса Pricemin. ");
        $("#prompt_p").append("<br>");
        $("#prompt_p").append("<span class='prompt2 text_left text_large'>");
        ...
        $("#prompt_p").append("<br>");
        $("#prompt_p").append("<span class='prompt7 text_large'>");
        ...
        $("#prompt_p").append("<br>");
        $("#prompt_p").append("<span class='prompt8 text_large'>");
        ...
        $("#prompt_p").append("<br>");
        $("#prompt_p").append("<span class='prompt9 text_x-large'>");
        $(".prompt9").text("e-mail: pricemin@mail.ru");
        $("#prompt_p").append("<br>");
        $("#prompt_p").append("<span class='prompt10 text_large'>");
        $(".prompt10").text("========================================================================================================================================");
        url = $(this).attr('href');
    });
